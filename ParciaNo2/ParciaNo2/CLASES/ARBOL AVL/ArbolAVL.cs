...
namespace ParciaNo2.CLASES.ARBOL_AVL
{
    class ArbolAVL
    {
        ...
        {
            Comparador dato;
            Logica h = new Logica(false); // intercambia un valor booleano
        ...
        private NodoAvl insertarAvl(NodoAvl raiz, Comparador dt, Logica h)
        //throws Exception
        {
            NodoAvl n1;
            if (raiz == null)
        ...
        private NodoAvl reemplazar(NodoAvl n, NodoAvl act, Logica cambiaAltura)
        {
        ...
        private NodoAvl equilibrar1(NodoAvl n, Logica cambiaAltura)
        {
            NodoAvl n1;
            switch (n.fe)
            {
        ...
        private NodoAvl equilibrar2(NodoAvl n, Logica cambiaAltura)
        {
            NodoAvl n1;
            switch (n.fe)
            {
        ...
        public void contador()
        {
            ...
            b = b+acumulador;
            acumulador = 0;
            MessageBox.Show("vuelta Nodo No." + b);
        }
        //este es el buscar con carne
        protected Nodo buscar(Nodo raizSub, Comparador buscado)
        {
